...
{
    [ConnectionKey("Default"), Module("Operation"), TableName("[dbo].[BusinessTrip]")]
    [DisplayName("Business Trips"), InstanceName("Business Trip")]
    [LookupScript(LookupType = typeof(MultiTenantRowLookupScript<>))]
    [ReadPermission("Operation:BusinessTrip")]
    [ModifyPermission("Operation:BusinessTrip")]
    public sealed class BusinessTripRow : LoggingRow<BusinessTripRow.RowFields>, IIdRow, INameRow, IMultiTenantRow
    {
        ...
        [DisplayName("Items"), MasterDetailRelation(foreignKey: "BusinessTripId"), NotMapped]
        public List<BusinessTripParticipantRow> ItemList
        {
        ...
        public BusinessTripRow(RowFields fields)
            : base(fields)
        {
        }
        ...
        public class RowFields : LoggingRowFields
        {
            ...
            public RowListField<BusinessTripParticipantRow> ItemList;
