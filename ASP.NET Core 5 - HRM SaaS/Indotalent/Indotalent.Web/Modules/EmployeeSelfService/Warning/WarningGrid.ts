...
namespace Indotalent.EmployeeSelfService {
    ...
    export class WarningGrid extends Serenity.EntityGrid<WarningRow, any> {
        protected getColumnsKey() { return WarningColumns.columnsKey; }
        protected getDialogType() { return WarningDialog; }
        ...
        protected getColumns() {
            ...
            if (!Q.Authorization.hasPermission("Administration:Tenant")) {
                columns = columns.filter(x => x.field != WarningRow.Fields.TenantName && x.field != WarningRow.Fields.Id);
            }
