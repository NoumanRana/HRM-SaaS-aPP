...
{
    [ConnectionKey("Default"), Module("Organization"), TableName("[dbo].[Department]")]
    [DisplayName("Department"), InstanceName("Department")]
    [ReadPermission("Organization:Department")]
    [ModifyPermission("Organization:Department")]
    [LookupScript(LookupType = typeof(MultiTenantRowLookupScript<>), Permission = "?")]
    public sealed class DepartmentRow : LoggingRow<DepartmentRow.RowFields>, IIdRow, INameRow, IMultiTenantRow
    {
