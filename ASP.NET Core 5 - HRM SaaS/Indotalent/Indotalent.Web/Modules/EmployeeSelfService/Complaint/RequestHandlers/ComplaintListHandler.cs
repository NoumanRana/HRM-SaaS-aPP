...
using MyResponse = Serenity.Services.ListResponse<Indotalent.EmployeeSelfService.ComplaintRow>;
...
namespace Indotalent.EmployeeSelfService
{
    ...
    public class ComplaintListHandler : ListRequestHandler<MyRow, MyRequest, MyResponse>, IComplaintListHandler
    {
        ...
        public ComplaintListHandler(IRequestContext context, IUserRetrieveService userRetrieveService, IUserAccessor userAccessor)
             : base(context)
        {
        ...
        protected override void PrepareQuery(SqlQuery query)
        {
            ...
            if (UserRetrieveService.ByUsername(username) is UserDefinition user)
            {
                ...
                query.Where(ComplaintRow.Fields.ReporterId == employeeId);
            }
        }
    }
}