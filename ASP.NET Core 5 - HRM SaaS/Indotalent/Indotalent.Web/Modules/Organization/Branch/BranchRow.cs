...
{
    [ConnectionKey("Default"), Module("Organization"), TableName("[dbo].[Branch]")]
    [DisplayName("Branch"), InstanceName("Branch")]
    [ReadPermission("Organization:Branch")]
    [ModifyPermission("Organization:Branch")]
    [LookupScript(LookupType = typeof(MultiTenantRowLookupScript<>), Permission = "?")]
    public sealed class BranchRow : LoggingRow<BranchRow.RowFields>, IIdRow, INameRow, IMultiTenantRow
    {
