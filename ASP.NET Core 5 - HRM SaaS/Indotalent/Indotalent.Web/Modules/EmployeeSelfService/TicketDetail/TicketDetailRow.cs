...
{
    [ConnectionKey("Default"), Module("EmployeeSelfService"), TableName("[dbo].[TicketDetail]")]
    [DisplayName("Ticket Responses"), InstanceName("Ticket Response")]
    [ReadPermission("EmployeeSelfService:Ticket")]
    [ModifyPermission("EmployeeSelfService:Ticket")]
