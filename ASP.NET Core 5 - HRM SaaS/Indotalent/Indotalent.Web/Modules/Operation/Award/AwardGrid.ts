...
namespace Indotalent.Operation {
    ...
    export class AwardGrid extends Serenity.EntityGrid<AwardRow, any> {
        protected getColumnsKey() { return AwardColumns.columnsKey; }
        protected getDialogType() { return AwardDialog; }
        ...
        protected getColumns() {
            ...
            if (!Q.Authorization.hasPermission("Administration:Tenant")) {
                columns = columns.filter(x => x.field != AwardRow.Fields.TenantName && x.field != AwardRow.Fields.Id);
            }
