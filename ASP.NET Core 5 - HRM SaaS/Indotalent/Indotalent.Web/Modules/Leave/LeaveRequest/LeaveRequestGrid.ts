...
namespace Indotalent.Leave {
    ...
    export class LeaveRequestGrid extends Serenity.EntityGrid<LeaveRequestRow, any> {
        protected getColumnsKey() { return LeaveRequestColumns.columnsKey; }
        protected getDialogType() { return LeaveRequestDialog; }
        ...
        protected getColumns() {
            ...
            if (!Q.Authorization.hasPermission("Administration:Tenant")) {
                columns = columns.filter(x => x.field != LeaveRequestRow.Fields.TenantName && x.field != LeaveRequestRow.Fields.Id);
            }
