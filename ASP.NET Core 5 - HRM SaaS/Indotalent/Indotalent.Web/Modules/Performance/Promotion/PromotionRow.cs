...
{
    [ConnectionKey("Default"), Module("Performance"), TableName("[dbo].[Promotion]")]
    [DisplayName("Promotions"), InstanceName("Promotion")]
    [LookupScript(LookupType = typeof(MultiTenantRowLookupScript<>))]
    [ReadPermission("Performance:Promotion")]
    [ModifyPermission("Performance:Promotion")]
    public sealed class PromotionRow : LoggingRow<PromotionRow.RowFields>, IIdRow, INameRow, IMultiTenantRow
    {
        ...
        [DisplayName("Promotion Date"), NotNull]
        ...
        [DisplayName("Promotion Reason"), MasterDetailRelation(foreignKey: "PromotionId"), NotMapped]
        public List<PromotionReasonRow> PromotionReasonList
        {
            get => fields.PromotionReasonList[this];
            set => fields.PromotionReasonList[this] = value;
        }

        [DisplayName("Promotion Competency"), MasterDetailRelation(foreignKey: "PromotionId"), NotMapped]
        public List<PromotionCompetencyRow> PromotionCompetencyList
        {
            get => fields.PromotionCompetencyList[this];
            set => fields.PromotionCompetencyList[this] = value;
        }
        ...
        public PromotionRow(RowFields fields)
            : base(fields)
        {
        }
        ...
        public class RowFields : LoggingRowFields
        {
            ...
            public RowListField<PromotionReasonRow> PromotionReasonList;

            public RowListField<PromotionCompetencyRow> PromotionCompetencyList;
