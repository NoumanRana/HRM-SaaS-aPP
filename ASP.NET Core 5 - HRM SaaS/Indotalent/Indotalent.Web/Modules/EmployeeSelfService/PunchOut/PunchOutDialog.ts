...
namespace Indotalent.EmployeeSelfService {
    ...
    export class PunchOutDialog extends Serenity.EntityDialog<PunchOutRow, any> {
        ...
        protected afterLoadEntity() {
            ...
            Serenity.EditorUtils.setReadOnly(this.form.PunchDate, true);
            Serenity.EditorUtils.setReadOnly(this.form.OutHour, true);
            Serenity.EditorUtils.setReadOnly(this.form.OutMinute, true);
        }
