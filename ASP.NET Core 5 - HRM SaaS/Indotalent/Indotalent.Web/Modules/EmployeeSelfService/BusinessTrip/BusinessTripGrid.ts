...
namespace Indotalent.EmployeeSelfService {
    ...
    export class BusinessTripGrid extends Serenity.EntityGrid<BusinessTripRow, any> {
        ...
        protected getColumns() {
            ...
            if (!Q.Authorization.hasPermission("Administration:Tenant")) {
                columns = columns.filter(x => x.field != BusinessTripRow.Fields.TenantName && x.field != BusinessTripRow.Fields.Id);
            }
