...
{
    [ConnectionKey("Default"), Module("EmployeeSelfService"), TableName("[dbo].[Meeting]")]
    [DisplayName("Meetings"), InstanceName("Meeting")]
    [LookupScript(LookupType = typeof(MultiTenantRowLookupScript<>))]
    [ReadPermission("EmployeeSelfService:Meeting")]
    [ModifyPermission("EmployeeSelfService:Meeting")]
    public sealed class MeetingRow : LoggingRow<MeetingRow.RowFields>, IIdRow, INameRow, IMultiTenantRow
    {
        ...
        [DisplayName("Items"), MasterDetailRelation(foreignKey: "MeetingId"), NotMapped]
        public List<MeetingParticipantRow> ItemList
        {
        ...
        public class RowFields : LoggingRowFields
        {
            ...
            public RowListField<MeetingParticipantRow> ItemList;
