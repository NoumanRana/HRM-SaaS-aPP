...
{
    [ConnectionKey("Default"), Module("Recruitment"), TableName("[dbo].[VacancyRequirement]")]
    [DisplayName("Job Requirements"), InstanceName("Job Requirement")]
    [ReadPermission("Recruitment:Vacancy")]
    [ModifyPermission("Recruitment:Vacancy")]
    [LookupScript(LookupType = typeof(MultiTenantRowLookupScript<>))]
    public sealed class VacancyRequirementRow : LoggingRow<VacancyRequirementRow.RowFields>, IIdRow, INameRow, IMultiTenantRow
    {
        ...
        [DisplayName("Requirement"), NotNull, NameProperty]
        ...
        public VacancyRequirementRow()
            : base()
        {
        }

        public VacancyRequirementRow(RowFields fields)
            : base(fields)
        {
        }
