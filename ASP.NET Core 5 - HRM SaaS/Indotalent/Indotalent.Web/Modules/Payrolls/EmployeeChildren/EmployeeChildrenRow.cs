...
{
    [ConnectionKey("Default"), Module("Payrolls"), TableName("[dbo].[EmployeeChildren]")]
    [DisplayName("Employee Childrens"), InstanceName("Employee Children")]
    [ReadPermission("Payrolls:Employee")]
    [ModifyPermission("Payrolls:Employee")]
    [LookupScript(LookupType = typeof(MultiTenantRowLookupScript<>))]
    public sealed class EmployeeChildrenRow : LoggingRow<EmployeeChildrenRow.RowFields>, IIdRow, INameRow, IMultiTenantRow
    {
        ...
        public EmployeeChildrenRow()
            : base()
        {
        }

        public EmployeeChildrenRow(RowFields fields)
            : base(fields)
        {
        }
