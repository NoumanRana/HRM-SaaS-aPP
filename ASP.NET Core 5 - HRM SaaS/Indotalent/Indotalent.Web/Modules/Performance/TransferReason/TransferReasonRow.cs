...
{
    [ConnectionKey("Default"), Module("Performance"), TableName("[dbo].[TransferReason]")]
    [DisplayName("Transfer Reasons"), InstanceName("Transfer Reason")]
    [ReadPermission("Performance:Transfer")]
    [ModifyPermission("Performance:Transfer")]
    [LookupScript(LookupType = typeof(MultiTenantRowLookupScript<>))]
    public sealed class TransferReasonRow : LoggingRow<TransferReasonRow.RowFields>, IIdRow, INameRow, IMultiTenantRow
    {
        ...
        public TransferReasonRow()
            : base()
        {
        }

        public TransferReasonRow(RowFields fields)
            : base(fields)
        {
        }
