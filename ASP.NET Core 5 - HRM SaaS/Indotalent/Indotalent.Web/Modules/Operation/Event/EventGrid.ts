...
namespace Indotalent.Operation {
    ...
    export class EventGrid extends Serenity.EntityGrid<EventRow, any> {
        protected getColumnsKey() { return EventColumns.columnsKey; }
        ...
        protected getColumns() {
            ...
            if (!Q.Authorization.hasPermission("Administration:Tenant")) {
                columns = columns.filter(x => x.field != EventRow.Fields.TenantName && x.field != EventRow.Fields.Id);
            }
