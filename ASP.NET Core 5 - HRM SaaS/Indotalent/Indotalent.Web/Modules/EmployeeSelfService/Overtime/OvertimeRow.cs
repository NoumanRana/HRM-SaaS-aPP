...
{
    [ConnectionKey("Default"), Module("EmployeeSelfService"), TableName("[dbo].[Overtime]")]
    [DisplayName("Overtimes"), InstanceName("Overtime")]
    [LookupScript(LookupType = typeof(MultiTenantRowLookupScript<>))]
    [ReadPermission("EmployeeSelfService:Overtime")]
    [ModifyPermission("EmployeeSelfService:Overtime")]
