...
namespace Indotalent.EmployeeSelfService {
    ...
    export class PunchInGrid extends Serenity.EntityGrid<PunchInRow, any> {
        protected getColumnsKey() { return PunchInColumns.columnsKey; }
        protected getDialogType() { return PunchInDialog; }
        ...
        protected getColumns() {
            ...
            if (!Q.Authorization.hasPermission("Administration:Tenant")) {
                columns = columns.filter(x => x.field != PunchInRow.Fields.TenantName && x.field != PunchInRow.Fields.Id);
            }
