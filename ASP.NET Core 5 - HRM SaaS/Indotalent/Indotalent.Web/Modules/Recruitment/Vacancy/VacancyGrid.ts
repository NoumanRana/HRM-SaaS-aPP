...
namespace Indotalent.Recruitment {
    ...
    export class VacancyGrid extends Serenity.EntityGrid<VacancyRow, any> {
        protected getColumnsKey() { return VacancyColumns.columnsKey; }
        protected getDialogType() { return VacancyDialog; }
        ...
        protected getColumns() {
            ...
            if (!Q.Authorization.hasPermission("Administration:Tenant")) {
                columns = columns.filter(x => x.field != VacancyRow.Fields.TenantName && x.field != VacancyRow.Fields.Id);
            }
