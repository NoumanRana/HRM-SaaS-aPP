...
namespace Indotalent.Operation {
    ...
    export class AssetGrid extends Serenity.EntityGrid<AssetRow, any> {
        protected getColumnsKey() { return AssetColumns.columnsKey; }
        protected getDialogType() { return AssetDialog; }
        ...
        protected getColumns() {
            ...
            if (!Q.Authorization.hasPermission("Administration:Tenant")) {
                columns = columns.filter(x => x.field != AssetRow.Fields.TenantName && x.field != AssetRow.Fields.Id);
            }
