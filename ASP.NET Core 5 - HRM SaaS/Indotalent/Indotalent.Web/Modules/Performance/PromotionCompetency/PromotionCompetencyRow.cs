...
{
    [ConnectionKey("Default"), Module("Performance"), TableName("[dbo].[PromotionCompetency]")]
    [DisplayName("Promotion Competencies"), InstanceName("Promotion Competency")]
    [ReadPermission("Performance:Promotion")]
    [ModifyPermission("Performance:Promotion")]
    [LookupScript(LookupType = typeof(MultiTenantRowLookupScript<>))]
    public sealed class PromotionCompetencyRow : LoggingRow<PromotionCompetencyRow.RowFields>, IIdRow, INameRow, IMultiTenantRow
    {
        ...
        public PromotionCompetencyRow()
            : base()
        {
        }

        public PromotionCompetencyRow(RowFields fields)
            : base(fields)
        {
        }
