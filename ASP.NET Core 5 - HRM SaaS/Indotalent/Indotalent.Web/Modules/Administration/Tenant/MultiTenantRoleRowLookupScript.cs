...
namespace Indotalent
{
    ...
    public class MultiTenantRoleRowLookupScript<TRow> : RowLookupScript<TRow>
        where TRow : class, IRow, IMultiTenantRow, new()
    {
        ...
        public MultiTenantRoleRowLookupScript(ISqlConnections connections, IUserRetrieveService userRetrieveService, IUserAccessor userAccessor, ITwoLevelCache cache) : base(connections)
        {
