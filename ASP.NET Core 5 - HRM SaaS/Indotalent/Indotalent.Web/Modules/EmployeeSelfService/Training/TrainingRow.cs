...
{
    [ConnectionKey("Default"), Module("EmployeeSelfService"), TableName("[dbo].[Training]")]
    [DisplayName("Trainings"), InstanceName("Training")]
    [LookupScript(LookupType = typeof(MultiTenantRowLookupScript<>))]
    [ReadPermission("EmployeeSelfService:Training")]
    [ModifyPermission("EmployeeSelfService:Training")]
    public sealed class TrainingRow : LoggingRow<TrainingRow.RowFields>, IIdRow, INameRow, IMultiTenantRow
    {
        ...
        [DisplayName("Items"), MasterDetailRelation(foreignKey: "TrainingId"), NotMapped]
        public List<TrainingParticipantRow> ItemList
        {
        ...
        public TrainingRow(RowFields fields)
            : base(fields)
        {
        }
        ...
        public class RowFields : LoggingRowFields
        {
            ...
            public RowListField<TrainingParticipantRow> ItemList;
