namespace Indotalent.Texts {
    ...
    declare namespace Db {
        ...
        namespace Payrolls {
            ...
            namespace Deduction {
                export const DeductionRate: string;
                export const Description: string;
                export const Id: string;
                export const InsertDate: string;
                export const InsertUserId: string;
            ...
            namespace SalaryTaxSlab {
                export const ExemptedAmount: string;
                export const From: string;
                export const Rate: string;
                export const SlabRange: string;
                export const TaxSlabId: string;
